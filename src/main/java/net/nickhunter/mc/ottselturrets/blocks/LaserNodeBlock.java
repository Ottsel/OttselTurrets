...
public class LaserNodeBlock extends AnimatedBlock {
    ...
    public static final VoxelShape HITBOX_AABB = Block.makeCuboidShape(2D, 0D, 2D, 14D, 5D, 14D);
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        return super.getStateForPlacement(context).with(BlockStateProperties.POWERED, false)
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        LaserNodeTileEntity tileEntity = getTileEntity(worldIn, pos);
        if (tileEntity != null)
            tileEntity.onBlockDestroyed(player);
    }
