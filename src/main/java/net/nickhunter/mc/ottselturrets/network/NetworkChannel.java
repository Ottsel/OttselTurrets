...
public class NetworkChannel {
    ...
    public NetworkChannel(final String channelName){
        INSTANCE = NetworkRegistry.newSimpleChannel(
                new ResourceLocation(OttselTurrets.MOD_ID, channelName),
                () -> PROTOCOL_VERSION,
    ...
    public <MSG extends OttselPacket> void registerMessage(final int id, final Class<MSG> msgClazz, final Function<PacketBuffer, MSG> msgCreator)
    {
